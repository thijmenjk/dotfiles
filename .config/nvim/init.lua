...
require('lazy').setup({
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>c'] = {
          ...
          p = { '<cmd>ChatGPTRun add_tests<CR>', 'Add Tests', mode = { 'n', 'v' } },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-n>', builtin.lsp_workspace_symbols, {})
      vim.keymap.set('n', '<leader>n', builtin.lsp_document_symbols, {})
